...
* Branch to build: [main](https://github.com/amesones-dev/py-holder/tree/main)
* [Dockerfile](https://github.com/amesones-dev/py-holder/blob/main/run/Dockerfile)  
* Running the application with  Flask: [start.py](https://github.com/amesones-dev/py-holder/blob/main/src/start.py)
...
# Output
    ...
    #10 naming to docker.io/library/py-holder-main-24754-1691654416 done
  #10 DONE 0.8s
...
# Output
  ...
  py-holder-main-24754-1691654416   latest    a0bdb9a4065c   5 seconds ago   102MB
...
# Output
  ...
  3127ed2ef041   py-holder-main-24754-1691654416   "python start.py"   3 minutes ago   Up 3 minutes   0.0.0.0:8081->8081/tcp   beautiful_jackson
